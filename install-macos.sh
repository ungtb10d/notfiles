...
install_force_full_desktop_bar() {
	...
	{ set +x; } 2>/dev/null
	install_launch_daemon com.ungtb10d.ForceFullDesktopBar.plist
}
...
install_ios_scaler() {
	...
	{ set +x; } 2>/dev/null
	install_launch_daemon com.ungtb10d.iOSScaler.plist
}
...
install_disable_diagnostics_reporter() {
	...
	{ set +x; } 2>/dev/null
	install_launch_daemon com.ungtb10d.DisableDiagnosticsReporter.plist
}
...
ask "Install hyper key remap?" && checked_copy com.ungtb10d.RemapHyper.plist ~/Library/LaunchAgents/com.ungtb10d.RemapHyper.plist && launchctl load ~/Library/LaunchAgents/com.ungtb10d.RemapHyper.plist
